        ...
        <div className="w-[48%] h-[80%]  flex justify-around items-center flex-col ">
          <div className="w-full h-[60%]   flex justify-center flex-col gap-5">
            ...
            <p className="font-semi-bold text-grey text-[15px]">
              ...
              <span className="text-grey font-bold  text-xl"> $58.00 </span> +
              Free Shipping Nam nec tellus a odio tincidunt auctor a ornare
          ...
          <div className="w-full h-[35%]  flex flex-col">
            <div className="w-[80%] h-[50%] bg-[white] border-t-2 border-[#3B82F6] border-b-2  flex justify-center items-center">
              <div className="w-[45%] h-[80%] flex items-center justify-center ">
                <div className="w-[20%] h-[60%] bg-[white] border-solid border-2 border-[#ebe8e8] flex justify-center items-center">
                  +
                </div>
                <div className="w-[20%] h-[60%] bg-[white] border-solid border-2 border-[#ebe8e8] flex justify-center items-center">
                  1
              ...
              <div className="w-[50%] h-[80%] flex justify-center items-center">
                <button className="w-[70%] h-[80%] bg-[#3B82F6] text-white rounded-[8px] font-bold">
                  Add to Cart
                </button>
              </div>
            </div>
