...
<p className="font-bold text-black text-medium">EMAIL ADDRESS</p>
          <input type="text " placeholder="Email" className="w-[370px] h-[50px] bg-[#ffff] rounded-[10px] border-solid border-2 border-sky-500 focus:border border-[lightgrey] focus:outline-none"
          ...
          <input type="text " placeholder="Enter Password" className="w-[370px] h-[50px] bg-[#ffff] rounded-[10px] border-solid border-2 border-sky-500 focus:border border-[lightgrey] focus:outline-none"
...
<button className="w-[200px] h-[40px] bg-sky-500 text-white font-bold rounded-[10px] text-center">Log in</button>
</div>
    </div>
  )
}
